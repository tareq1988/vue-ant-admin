...
<style scoped>
  #components-form-demo-normal-signup .signup-form {
    max-width: 300px;
  }
  #components-form-demo-normal-signup .login-form-forgot {
    /* float: right; */
  }
  #components-form-demo-normal-signup .signup-form-btn {
    width: 100%;
  }
